...
public class Exercicio {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < notasAlunoA.length; i++) { // usando o laço for para percorrer todo o array
						// notasAlunoA.length é um atributo do array.
			totalAlunoA += notasAlunoA[i]; // somatória de todas as notas
		}
